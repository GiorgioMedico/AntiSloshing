...
window_result_name = 'Resulting image'
low_H_name = 'Low H'
low_S_name = 'Low S'
low_V_name = 'Low V'
high_H_name = 'High H'
...
screen_width = 960  # Replace with your screen width
screen_height = 540  # Replace with your screen height
...
# Resize the image
frame = cv.resize(frame, (int(width * scaling_factor), int(height * scaling_factor)))
