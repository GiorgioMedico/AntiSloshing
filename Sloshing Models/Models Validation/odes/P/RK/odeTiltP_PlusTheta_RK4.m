function Sd = odeTiltP_PlusTheta_RK4(S,wn,zitan,xdd,ydd,zdd,psi,psid,psidd,dn,g,model_type)
%--------------------------------------------------------------------------
...
% dn = distance from center of rotation to pivot (IMPORTANT:
% e.g. if rotation is about container base dn = h - Ln, if about pendulum mass dn = ln)
