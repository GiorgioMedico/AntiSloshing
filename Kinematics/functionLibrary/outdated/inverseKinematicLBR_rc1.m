...
function [robot_solutions,robot_reachable_solutions,status] = inverseKinematicLBR_rc1(robot,GoalPoint,KUKA_R)
...
angolo_base_euroc = 0;
T_W0_TCP = inv(transl(0,0,L1))*inv(troty(angolo_base_maxima,'deg'))*T_W45_TCP;%*Ttool;
