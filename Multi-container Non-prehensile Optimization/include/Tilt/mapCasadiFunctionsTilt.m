...
if exist('get_p_06_0', 'var')
    ...
    p06 = get_p_06_0_map(s_o,thx_o,thy_o);
end
if exist('get_R06', 'var')
    get_R06_map = get_R06.map(N+1);
    R06 = get_R06_map(s_o,thx_o,thy_o);
end
if exist('get_v_06_0', 'var')
    get_v_06_0_map = get_v_06_0.map(N+1);
    v06 = get_v_06_0_map(s_o, s_dot_o,thx_o,thy_o,thx_dot_o,thy_dot_o);
end
if exist('get_a_06_0', 'var')
    get_a_06_0_map = get_a_06_0.map(N+1);
    a06 = get_a_06_0_map(s_o,s_dot_o,s_ddot_o,thx_o,thy_o,thx_dot_o,thy_dot_o,thx_ddot_o,thy_ddot_o);
end
if exist('get_w06_0', 'var')
    get_w06_0_map = get_w06_0.map(N+1);
    w06_0 = get_w06_0_map(s_o, s_dot_o,thx_o,thy_o,thx_dot_o,thy_dot_o);
end
if exist('get_w06_0_dot', 'var')
    get_w06_0_dot_map = get_w06_0_dot.map(N+1);
    w06_0_dot = get_w06_0_dot_map(s_o,s_dot_o,s_ddot_o,thx_o,thy_o,thx_dot_o,thy_dot_o,thx_ddot_o,thy_ddot_o);
end
...
if exist('get_R07', 'var')
    ...
    R07 = get_R07_map(s_o,thx_o,thy_o);
end
...
if exist('get_w07_0', 'var')
    ...
    w07 = get_w07_0_map(s_o, s_dot_o,thx_o,thy_o,thx_dot_o,thy_dot_o);
end
if exist('get_w07_0_dot', 'var')
    get_w07_0_dot_map = get_w07_0_dot.map(N+1);
    w07_dot = get_w07_0_dot_map(s_o,s_dot_o,s_ddot_o,thx_o,thy_o,thx_dot_o,thy_dot_o,thx_ddot_o,thy_ddot_o);
end
...
if exist('get_q_dot', 'var')
    ...
    q_dot = get_q_dot_map(s_o, s_dot_o,thx_o,thy_o,thx_dot_o,thy_dot_o);
end
