function [save_fig, save_csv, csv_joint_offset, animations] = getSimulationParametersTilt()
...
%   animations: Boolean value for animations.
    ...
    % --- Animations ---
    [animationsField, animationsExplanation] = createBooleanControl(inputPanel, 'Animations (true/false):', defaultAnimations, 460, ...
...
% updateParameters updates the stored parameter value.
    ...
    if any(strcmp(paramName, {'save_fig', 'save_csv', 'animations'}))
