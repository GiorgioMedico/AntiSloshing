function [ ] = ploteps(name, width, height, FontSizeLabel, FontSizeAxis, XTick, YTick, saveInDir)
%PLOTEPS
% ploteps(name, width, height, FontSizeLabel, FontSizeAxis, XTick, YTick, saveInDir)
%   Creates a file of the gcf with name.eps with spezified widht and height
%   Furthermore a tex file will be created where the Properties of the Text
%   can be modified.
%   name............................String of the name
%   width...........................Widht in centimeters
%   height..........................Height in centimeters
%   FontSizeLabel...................Fontsize of the x- and y-label
%   FontSizeAxis....................Fontsize of the axes
%   XTick...........................Tick of the xAxis (if only 2 elements are passed they are used as limits)
%   YTick...........................Tick of the yAxis (if only 2 elements are passed they are used as limits)
%   saveInDir.......................Copies the Plots into the specified
%                                   directory
...
xlab = get(xlhand,'string');
ylab = get(ylhand,'string');

if(nargin>=4 && FontSizeLabel>0)
    set(xlhand,'FontSize',FontSizeLabel);
    set(ylhand,'FontSize',FontSizeLabel);
end
if(nargin>=5 && FontSizeAxis>0)
...
set(xlhand,'string',['$' xlab '$']);
set(ylhand,'string',['$' ylab '$']);
...
DirName = 'plots';
if(nargin == 8 && ischar(saveInDir))
    DirName = saveInDir;
end
[s,mess,messid] = mkdir(DirName);
movefile(strcat(name,'.eps'),strcat(pwd,['\' DirName]));
movefile(strcat(name,'.tex'),strcat(pwd,['\' DirName]));
end
